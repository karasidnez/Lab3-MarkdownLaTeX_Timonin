...
## Структура проекта
- Lab3_MarkdownLaTeX_Timonin
  - docs(Markdown-файлы с примерами)
     -  advancedMarkdownLab3_Timonin
     -  codeQuotesLab3_Timonin
     -  formattingLab3_Timonin
     -  headersLab3_Timonin
     -  LatexLab3_Timomini
     -  linksImagesLab3_Timonin
     -  listsLab3_Timonin
     -  ReadmePushLab3_Timonin
     -  separatorsLab3_Timonin
     -  tablesLab3_Timonin
	- img(Скриншоты выполнения заданий)
	   - advancedMarkdownCommitLab3_Timonin
	   - codeCommitLab3_Timonin
	   - commitStructureLab3_Timonin
	   - formattingCommitLab3_Timonin
	   - gitPushLab3_Timonin
	   - headersCommitLab3_Timonin
	   - latexCommitLab3_Timonin
	   - linksCommitLab3_Timonin
	   - listsCommitLab3_Timonin.png 
	   - separatorsCommitLab3_Timonin
	   - tablesCommitLab3_Timonin
